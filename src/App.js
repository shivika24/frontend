...
class App extends Component {
  ...
  data11(a)
  {
    this.setState({myarr1:a,sid:a.mainid});
      ...
      <BrowserRouter>
        ...
        <div>        
          ...
          {this.state.loding || !this.state.statedata ? (
            ...
            <div>
              <div>{console.log("loading done")}</div>
          ...
          />
              ...
              />
              {console.log(this.state.myarr1)}
              <Route path="/display" render={() => (
                <Displaydata
                ondata={this.selected}
                data={this.state.myarr1[0]}
                oneditn={this.editn}
                />
              )}/>
